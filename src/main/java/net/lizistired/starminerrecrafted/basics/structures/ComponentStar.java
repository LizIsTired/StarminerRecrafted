...
//        this.GRASSSET_GRASS = new ComponentStar.BlockMeta(TallGrassGravitizedBlock, 1);
//        this.GRASSSET_FERN = new ComponentStar.BlockMeta(TallGrassGravitizedBlock, 2);
//        this.GRASSSET_PLANT_DANDELION = new ComponentStar.BlockMeta(PlantYelGravitizedBlock, 0);
//        this.GRASSSET_PLANT_POPPY = new ComponentStar.BlockMeta(PlantRedGravitizedBlock, 0);
//        this.GRASSSET_PLANT_BLUEORCHID = new ComponentStar.BlockMeta(PlantRedGravitizedBlock, 1);
//        this.GRASSSET_PLANT_ALLIUM = new ComponentStar.BlockMeta(PlantRedGravitizedBlock, 2);
//        this.GRASSSET_PLANT_HOUSTONIA = new ComponentStar.BlockMeta(PlantRedGravitizedBlock, 3);
//        this.GRASSSET_PLANT_TULIPRED = new ComponentStar.BlockMeta(PlantRedGravitizedBlock, 4);
//        this.GRASSSET_PLANT_TULIPORANGE = new ComponentStar.BlockMeta(PlantRedGravitizedBlock, 5);
//        this.GRASSSET_PLANT_TULIPWHITE = new ComponentStar.BlockMeta(PlantRedGravitizedBlock, 6);
//        this.GRASSSET_PLANT_TULIPPINK = new ComponentStar.BlockMeta(PlantRedGravitizedBlock, 7);
//        this.GRASSSET_PLANT_OXEYEDAISY = new ComponentStar.BlockMeta(PlantRedGravitizedBlock, 8);
...
//    }
//
//    public boolean addComponentParts(World par1World, Random par2Random, BlockBox chunkBoundingBox) {
//        this.rand.setSeed((long)(this.starSeed + chunkBoundingBox.getMinX() + chunkBoundingBox.getMinZ()));
//        int cx = this.starRad + 2 + this.getExpandBoundRad() + chunkBoundingBox.getMinX();
//        int cy = this.centerY;
//        int cz = this.starRad + 2 + this.getExpandBoundRad() + chunkBoundingBox.getMinZ();
...
//            int xMin = chunkBoundingBox.getMinX();
//            int xMax = chunkBoundingBox.getMaxX();
//            int yMin = cy - rad;
//            int yMax = cy + rad;
//            int zMin = chunkBoundingBox.getMinZ();
//            int zMax = chunkBoundingBox.getMaxZ();
...
//                                            par1World.setBlockState(x, y, z, surfaceBlockA, 0, 2);
...
//                                            par1World.setBlock(x, y, z, InnerCoreBlock, 0, 2);
//                                        } else if (distancePow < 16.0D) {
//                                            par1World.setBlock(x, y, z, OuterCoreBlock, 0, 2);
//                                        }
//                                    }
//                                }
//                            }
...
//            this.placeBlockAtCurrentPosition(par1World, GravityCoreBlock, 0, cx, cy, cz, chunkBoundingBox);
...
//    }
//
//    public boolean addComponentParts(World par1World, Random par2Random, BlockBox chunkBoundingBox, Block[] blocksData, byte[] blockMetas) {
//        this.rand.setSeed((long)(this.starSeed + chunkBoundingBox.getMinX() + chunkBoundingBox.getMinZ()));
//        boolean makeDimples = this.rand.nextBoolean();
//        ComponentStar.StarBiomeType starBiome = STAR_BIOMES[this.rand.nextInt(STAR_BIOMES.length)];
...
//                                        }
//                                    } else if (distancePow < 6.25D) {
//                                        blocksData[targetIdIndex] = InnerCoreBlock;
//                                        blockMetas[targetIdIndex] = 0;
//                                    } else if (distancePow < 16.0D) {
//                                        blocksData[targetIdIndex] = OuterCoreBlock;
//                                        blockMetas[targetIdIndex] = 0;
//                                    }
...
//    }
//
//    private void makeRing(World par1World, Random par2Random, BlockBox chunkBoundingBox, Block[] blocksData, byte[] blockMetas) {
...
//                int posY = cy + (int)d1;
//                int posZ = cz + (int)d2;
//                if ((prevPosX != posX || prevPosY != posY || prevPosZ != posZ) && posY >= 0 && posY <= 255 && posX >= chunkBoundingBox.getMinX() && posX <= chunkBoundingBox.getMaxX() && posZ >= chunkBoundingBox.getMinZ() && posZ <= chunkBoundingBox.getMaxZ()) {
//                    int targetIdIndex = posY << 8 | posZ - chunkBoundingBox.getMinZ() << 4 | posX - chunkBoundingBox.getMinX();
...
//    }
//
//    /*private void makeTrees(World par1World, Random par2Random, StructureBoundingBox chunkBoundingBox, Block[] blocksData, byte[] blockMetas, ComponentStar.StarBiomeType starBiome) {
//        this.rand.setSeed(this.starSeed);
...
//     */
//
//    private void makeDimples(World par1World, Random par2Random, BlockBox chunkBoundingBox, Block[] blocksData, byte[] blockMetas, Block surfaceBlock) {
//        this.rand.setSeed(this.starSeed);
//        int cx = this.starRad + 2 + this.getExpandBoundRad() + chunkBoundingBox.getMinX();
//        int cy = this.centerY;
//        int cz = this.starRad + 2 + this.getExpandBoundRad() + chunkBoundingBox.getMinZ();
...
//            int targetIdIndex = dimpleCPosY << 8 | dimpleCPosZ - chunkBoundingBox.getMinZ() << 4 | dimpleCPosX - chunkBoundingBox.getMinX();
//
...
//                                            if (!(xyzFarFromStarC > starRadPow) && posX >= chunkBoundingBox.getMinX() && posX <= chunkBoundingBox.getMaxX() && posZ >= chunkBoundingBox.getMinZ() && posZ <= chunkBoundingBox.getMaxZ()) {
//                                                targetIdIndex = posY << 8 | posZ - chunkBoundingBox.getMinZ() << 4 | posX - chunkBoundingBox.getMinX();
//                                                blocksData[targetIdIndex] = surfaceBlock;
//                                                blockMetas[targetIdIndex] = 0;
//                                            }
//                                        } else if (xyzFarFromDimpleC < dimpleRadSub1Pow && posX >= chunkBoundingBox.getMinX() && posX <= chunkBoundingBox.getMaxX() && posZ >= chunkBoundingBox.getMinZ() && posZ <= chunkBoundingBox.getMaxZ()) {
//                                            targetIdIndex = posY << 8 | posZ - chunkBoundingBox.getMinZ() << 4 | posX - chunkBoundingBox.getMinX();
//                                            blocksData[targetIdIndex] = Blocks.AIR;
//                                        }
//                                    }
...
//    }
//
//    protected void func_143012_a(NbtCompound par1NBTTagCompound) {
//        par1NBTTagCompound.putInt("starRad", this.starRad);
//        par1NBTTagCompound.putInt("ringRad", this.ringRad);
//        par1NBTTagCompound.putInt("centerY", this.centerY);
//        par1NBTTagCompound.putInt("starSeed", this.starSeed);
//    }
//
//    protected void func_143011_b(NbtCompound par1NBTTagCompound) {
//        this.starRad = par1NBTTagCompound.getInt("starRad");
//        this.ringRad = par1NBTTagCompound.getInt("ringRad");
//        this.centerY = par1NBTTagCompound.getInt("centerY");
//        this.starSeed = par1NBTTagCompound.getInt("starSeed");
//    }
//
//    static {
...
//        grassStar(DirtGrassExBlock, 5, 50, 0, 0, 0),
//        grassStarRich(DirtGrassExBlock, 2, 40, 1, 0, 0),
//        forestStar(DirtGrassExBlock, 3, 15, 0, 20, 4),
