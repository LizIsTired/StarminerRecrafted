...
public class MapGenStar {
    ...
    public boolean generateStructuresImmidiateInChunk(World par1World, Random par2Random, int par3, int par4, Block[] blocksData, byte[] blockMetas) {
        ...
        while(iterator.hasNext()) {
            net.lizistired.starminerrecrafted.basics.structures.StructureStarStart structurestart = (net.lizistired.starminerrecrafted.basics.structures.StructureStarStart)iterator.next();
